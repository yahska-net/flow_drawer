...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      ...
      home: FlowDrawerRightDockedExample(),
    );
  }
}
...
class FlowDrawerRightDockedExample extends StatefulWidget {
  const FlowDrawerRightDockedExample({super.key});

  @override
  State<FlowDrawerRightDockedExample> createState() =>
      _FlowDrawerRightDockedExampleState();
}

class _FlowDrawerRightDockedExampleState
    extends State<FlowDrawerRightDockedExample> {
  final controller = FlowDrawerController();
